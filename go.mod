module github.com/provenance-io/flatfees-oracle
...
// These replace directives are mirrored from provenance's go.mod. Importing
// github.com/provenance-io/provenance requires the SAME replaces (especially the
// cosmos-sdk fork) or the build will fail. Keep this block in sync with the
// provenance version pinned above. Run `go mod tidy` after any change.
replace (
	// Use cosmos fork of keyring (because the SDK does).
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0

	// Required for provenance issue #1414.
	...
	// iavl pin to fix the prune command.
	github.com/cosmos/iavl => github.com/cosmos/iavl v1.2.6

	// dgrijalva/jwt-go is deprecated.
